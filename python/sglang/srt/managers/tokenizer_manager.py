...
class TokenizerManager:
    ...
    def __init__(
        ...
        # Communicators
        factor = 2 if server_args.enable_bullet_engine else 1
        communicator_fan_out = server_args.dp_size * factor
        self.init_weights_update_group_communicator = _Communicator(
            self.send_to_scheduler, communicator_fan_out
        )
        ...
        self.rpc_call_communicator = _Communicator(
            self.send_to_scheduler, communicator_fan_out
        )
        ...
        self._result_dispatcher = TypeBasedDispatcher(
            [
                ...
                (
                    RpcReqOutput,
                    self.rpc_call_communicator.handle_recv,
                )
            ]
        )

    async def rpc_call(self, obj: RpcReqInput):
        return (await self.rpc_call_communicator(obj))[0]
