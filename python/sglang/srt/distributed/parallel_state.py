...
class GroupCoordinator:
    ...
    def __init__(
        ...
        # Bullet override
        self.bullet_first_rank = True
        self.bullet_last_rank = True
    ...
    def is_first_rank(self):
        ...
        return (self.rank == self.first_rank) and self.bullet_first_rank
    
    @is_first_rank.setter
    def is_first_rank(self, value: bool):
        self.bullet_first_rank = value

    @property
    def is_last_rank(self):
        """Return whether the caller is the last process in the group"""
        return (self.rank == self.last_rank) and self.bullet_last_rank

    @is_last_rank.setter
    def is_last_rank(self, value: bool):
        self.bullet_last_rank = value
